...
public class lackInstructionFuzzer implements iFuzzerTest{
	private static String OUTPUT_FILE = "";
	public int type = 0;
	public lackInstructionFuzzer(String file) {
		OUTPUT_FILE = file;
	}
	@Override
	...
	public static String getInstructions(String in, int type) {
		if(in.equals("add")) {
			return myInstruction.invalid_add_lack();
		}
		else if(in.equals("sub")) {
			return myInstruction.invalid_sub_lack();
		}
		else if(in.equals("mul")) {
			return myInstruction.invalid_mul_lack();
		}
		else if(in.equals("div")) {
			return myInstruction.invalid_div_lack();
		}
		else if(in.equals("ret")) {
			return myInstruction.invalid_ret_lack();
		}
